...
namespace EinsatzAendernNegativTest
{
    /// <summary>
    /// Zusammenfassungsbeschreibung für EinsatzErstellenNegativ
    /// </summary>
    [CodedUITest]
    public class EinsatzErstellenNegativ
    {
        public EinsatzErstellenNegativ()
        {
        }

        [TestMethod]
        public void ErstellenNegativ()
        {
            ...
            this.UIMap.Einsatz_Erstellen();
            this.UIMap.Ueberpruefe_Fehler();
            this.UIMap.Test_Cleanup();
        }
