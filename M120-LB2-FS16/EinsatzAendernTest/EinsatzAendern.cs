...
namespace EinsatzAendernTest
{
    /// <summary>
    /// Zusammenfassungsbeschreibung für EinsatzAendern
    /// </summary>
    [CodedUITest]
    public class EinsatzAendern
    {
        public EinsatzAendern()
        {
        }
        ...
        public void Aendern()
        {
            ...
            this.UIMap.Aendere_Einsatz();
            this.UIMap.Ueberpruefe_Aenderungen();
